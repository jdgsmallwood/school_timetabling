    ...
    def test_populate_students(self):
        data = DataFrame(
            columns=[
                ...
                "Family Name",
                "Student Id",
                "Component Study Package Code",
                "Component Study Package Title",
                "Study Period",
            ]
        )
        ...
        data["Component Study Package Title"] = [
...
class TimetableTests(BaseTest):
    ...
    def test_timetable(self):
        ...
        TUTORAVAILABILITYTEST["Jemima Capper"] = set(
            ["Monday 7:30pm", "Tuesday 9:30pm"]
        )
        SUBJECTMAPPINGTEST = {}
...
class TestViews(BaseTest):
    def setUpTestData(self):
        ...
        subject = Subject.get_or_create(
            subcode="ECON10005", subname="Quantitative Methods 1", repeats=1
        )
